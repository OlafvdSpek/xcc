...
function tr1a(gid, ws_gid, v, dura, scen, date, afps, crat, oosy, trny, echo_return_points)
{
	document.write('<tr>');
	...
	if (echo_return_points)
		document.write('<td><a href="https://d.xwis.net/admin/xcl_return_points.php?gid=', gid, '">Return points</a>');
}
