...
<tr><th class="maintitle" colspan="2" align="left" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="<?=$PHP_SELF?>?laddertype=1">XCC community ladder</a> &raquo; Search Result for <?=$id?></font></th></tr>
</table>
...
if($data[points] > 699) { $button = "<img src=\"images/ra2/ra2-red5.gif\" alt=\"\" border=\"0\">"; }
if($data[points] < 700 && $data[points] > 499) { $button = "<img src=\"images/ra2/ra2-red4.gif\" alt=\"\" border=\"0\">"; }
if($data[points] < 500 && $data[points] > 299) { $button = "<img src=\"images/ra2/ra2-red3.gif\" alt=\"\" border=\"0\">"; }
if($data[points] < 300 && $data[points] > 149) { $button = "<img src=\"images/ra2/ra2-red2.gif\" alt=\"\" border=\"0\">"; }
if($data[points] < 150 && $data[points] > 0) { $button = "<img src=\"images/ra2/ra2-red1.gif\" alt=\"\" border=\"0\">"; }
} else {
if($data[points] > 699) { $button = "<img src=\"images/ra2/ra2-blue5.gif\" alt=\"\" border=\"0\">"; }
if($data[points] < 700 && $data[points] > 499) { $button = "<img src=\"images/ra2/ra2-blue4.gif\" alt=\"\" border=\"0\">"; }
if($data[points] < 500 && $data[points] > 299) { $button = "<img src=\"images/ra2/ra2-blue3.gif\" alt=\"\" border=\"0\">"; }
if($data[points] < 300 && $data[points] > 149) { $button = "<img src=\"images/ra2/ra2-blue2.gif\" alt=\"\" border=\"0\">"; }
if($data[points] < 150 && $data[points] > 0) { $button = "<img src=\"images/ra2/ra2-blue1.gif\" alt=\"\" border=\"0\">"; }
}
...
<td width="32%"><font face="VERDANA,ARIAL,HELVETICA" size="2"><? if($ladr == "player") { ?><a href="<?=$PHP_SELF?>?mode=showplayer&laddertype=1&id=<?=$data[pid]?>"><? } else { ?><a href="<?=$PHP_SELF?>?mode=showclan&laddertype=1&id=<?=$data[pid]?>"><? } ?><u><font color="#FFFFB0"><u><b><?=$data[name]?></b></u></font></u></a></font></td>
...
<tr><th colspan="2" align="left" class="maintitle" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="<?=$PHP_SELF?>?laddertype=1">XCC community ladder</a> &raquo; Clanstats for [<?=$data[name]?>]</font></th></tr>
</table>
...
?>
<table class="maintitle" width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#000000">
<tr><th class="maintitle" colspan="2" align="left" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="<?=$PHP_SELF?>?laddertype=1">XCC community ladder</a> &raquo; Playerstats for <?=$data[name]?></font></th></tr>
</table>
...
?>
<table class="maintitle" width="100%" border="0" cellspacing="1" cellpadding="2">
<tr><th class="maintitle" colspan="2" align="left" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="<?=$PHP_SELF?>?laddertype=1">XCC community ladder</a> &raquo; Match #<?=$data[gid]?></font></th></tr>
</table>
