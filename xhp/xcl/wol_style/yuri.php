...
$player_lid = 3; // player lid in database
$clan_lid = 4; // clan lid in database
...
<tr><th class="maintitle" colspan="2" align="left" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="<?=$PHP_SELF?>?laddertype=2">XCC community ladder</a> &raquo; Search Result for <?=$id?></font></th></tr>
</table>
...
<META HTTP-EQUIV=Refresh CONTENT="1; URL=<?=$PHP_SELF?>?ladr=<?=$ladr?>&laddertype=2">
...
<img src="images/yuri/yuri-logo.gif" alt="" border="0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
<?
if(gmdate("d") == 1) { echo "<font size=\"3\" color=\"#FF8000\"><b>Ladder frozen</b></font>"; } else {
?>
<script language="JavaScript1.2">
function setcountdown(theyear,themonth,theday){
yr=theyear;mo=themonth;da=theday
}
setcountdown(<?=gmdate("Y")?>,<?=gmdate("m")?>,<?=gmdate("t")+1?>)
var occasion="reset"
...
dd=Date.parse(montharray[mo-1]+" "+da+", "+yr + " utc")-new Date()
...
if (document.layers){
document.countdownnsmain.document.countdownnssub.document.write(opentags+dday+ " days, "+dhour+" hours, "+dmin+" minutes and "+dsec+closetags)
document.countdownnsmain.document.countdownnssub.document.close()
}
else if (document.all||document.getElementById)
...
<ilayer id="countdownnsmain" visibility=hide><layer id="countdownnssub" left=0 top=0></layer></ilayer></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><font size="-2">(countdown until the ladder reset)</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<?
}
?>
</td>
...
if($data[points] > 699) { $button = "<img src=\"images/yuri/yuri-red3.jpg\" alt=\"\" border=\"0\">"; }
if($data[points] < 700 && $data[points] > 299) { $button = "<img src=\"images/yuri/yuri-red2.jpg\" alt=\"\" border=\"0\">"; }
if($data[points] < 300 && $data[points] > 0) { $button = "<img src=\"images/yuri/yuri-red1.jpg\" alt=\"\" border=\"0\">"; }
} elseif(get_side($data[countries]) == 2) {
if($data[points] > 700) { $button = "<img src=\"images/yuri/yuri-p3.jpg\" alt=\"\" border=\"0\">"; }
if($data[points] < 700 && $data[points] > 299) { $button = "<img src=\"images/yuri/yuri-p2.jpg\" alt=\"\" border=\"0\">"; }
if($data[points] < 300 && $data[points] > 0) { $button = "<img src=\"images/yuri/yuri-p1.jpg\" alt=\"\" border=\"0\">"; }
} else {
if($data[points] > 700) { $button = "<img src=\"images/yuri/yuri-blue3.gif\" alt=\"\" border=\"0\">"; }
if($data[points] < 700 && $data[points] > 299) { $button = "<img src=\"images/yuri/yuri-blue2.gif\" alt=\"\" border=\"0\">"; }
if($data[points] < 300 && $data[points] > 0) { $button = "<img src=\"images/yuri/yuri-blue1.gif\" alt=\"\" border=\"0\">"; }
}
...
<td width="32%"><font face="VERDANA,ARIAL,HELVETICA" size="2"><? if($ladr == "player") { ?><a href="<?=$PHP_SELF?>?mode=showplayer&laddertype=2&id=<?=$data[pid]?>"><? } else { ?><a href="<?=$PHP_SELF?>?mode=showclan&laddertype=2&id=<?=$data[pid]?>"><? } ?><u><font color="#FFFFB0"><u><b><?=$data[name]?></b></u></font></u></a></font></td>
...
<tr><th colspan="2" align="left" class="maintitle" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="<?=$PHP_SELF?>?laddertype=2">XCC community ladder</a> &raquo; Clanstats for [<?=$data[name]?>]</font></th></tr>
</table>
...
$matchtext = "<a href=\"$PHP_SELF?mode=showplayer&laddertype=2&id=".$rows1["pid"]."\"><Font color=\"FFFF00\">".$rows1["name"]."</a></font> ( ".$pts_clan1." pts ) Plays <a href=\"$PHP_SELF?mode=showplayer&laddertype=2&id=".$rows2["pid"]."\"><Font color=\"FFFF00\">".$rows2["name"]."</a></font> ( ".$pts_clan2." pts )";

} else {

if($data3[pc] > 1) {

$matchtext = "<a href=\"$PHP_SELF?mode=showplayer&laddertype=2&id=".$rows1["pid"]."\"><Font color=\"FFFF00\">".$rows1["name"]."</a></font> ( ".$pts_clan1." pts ) Defeats <a href=\"$PHP_SELF?mode=showplayer&laddertype=2&id=".$rows2["pid"]."\"><Font color=\"FFFF00\">".$rows2["name"]."</a></font> ( ".$pts_clan2." pts )";

} else {

$matchtext = "<a href=\"$PHP_SELF?mode=showplayer&laddertype=2&id=".$rows2["pid"]."\"><Font color=\"FFFF00\">".$rows2["name"]."</a></font> ( ".$pts_clan2." pts ) Defeats <a href=\"$PHP_SELF?mode=showplayer&laddertype=2&id=".$rows1["pid"]."\"><Font color=\"FFFF00\">".$rows1["name"]."</a></font> ( ".$pts_clan1." pts )";
...
$map = $map[0];
echo "$month $Tag, $Jahr";
?> - <?=$matchtext?> in game# <a href="<?=$PHP_SELF?>?laddertype=2&mode=showmatch&id=<?=$data2[gid]?>"><font color="80FFFF"><u><?=$data2[ws_gid]?></u></font></a>
<hr>
</td>
</tr>
<?
...
?>
<table class="maintitle" width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#000000">
<tr><th class="maintitle" colspan="2" align="left" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="<?=$PHP_SELF?>?laddertype=2">XCC community ladder</a> &raquo; Playerstats for <?=$data[name]?></font></th></tr>
</table>
...
$map = $map[0];
echo "$month $Tag, $Jahr";
?> - <?=$matchtext?> in game# <a href="<?=$PHP_SELF?>?mode=showmatch&laddertype=2&id=<?=$data2[gid]?>"><font color="80FFFF"><u><?=$data2[ws_gid]?></u></font></a>
<hr>
</td>
</tr>
<?
...
?>
<table class="maintitle" width="100%" border="0" cellspacing="1" cellpadding="2">
<tr><th class="maintitle" colspan="2" align="left" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="<?=$PHP_SELF?>?laddertype=2">XCC community ladder</a> &raquo; Match #<?=$data[gid]?></font></th></tr>
</table>
...
if($clansh != "") { $alink = "<a href=\"$PHP_SELF?mode=showclan&laddertype=2&id=$data3[cid]\">"; } else { $alink = "<a href=\"$PHP_SELF?mode=showplayer&laddertype=2&id=$data_nick1[pid]\">"; }
?>
...
var todaysec=today.getUTCSeconds()
var todaystring=montharray[todaym]+" "+todayd+", "+todayy+" "+todayh+":"+todaymin+":"+todaysec
dd=Date.parse(montharray[mo-1]+" "+da+", "+yr + " utc")-today
dday=Math.floor(dd/(60*60*1000*24)*1)
dhour=Math.floor((dd%(60*60*1000*24))/(60*60*1000)*1)
dmin=Math.floor(((dd%(60*60*1000*24))%(60*60*1000))/(60*1000)*1)
dsec=Math.floor((((dd%(60*60*1000*24))%(60*60*1000))%(60*1000))/1000*1)
