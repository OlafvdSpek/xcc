...
?>in game# <a href="?laddertype=2&mode=showmatch&id=<?=$data2[gid]?>"><font color="80FFFF"><u><?=$data2[ws_gid]?></u></font></a>
<hr>
...
$map = $map[0];
printf('%s - %s ', gmdate('M d, Y', $data2['mtime']), $matchtext);
?>in game# <a href="?mode=showmatch&laddertype=2&id=<?=$data2[gid]?>"><font color="80FFFF"><u><?=$data2[ws_gid]?></u></font></a>
<hr>
