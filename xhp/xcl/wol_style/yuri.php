...
<tr><th class="maintitle" colspan="2" align="left" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="?laddertype=2">XCC community ladder</a> &raquo; Search Result for <?=$id?></font></th>
</table>
...
<META HTTP-EQUIV=Refresh CONTENT="1; URL=?ladr=<?=$ladr?>&laddertype=2">
...
<td width="12%"><?=$button?>
<td width="32%"><font face="VERDANA,ARIAL,HELVETICA" size="2"><? if($ladr == "player") { ?><a href="?mode=showplayer&laddertype=2&id=<?=$data[pid]?>"><? } else { ?><a href="?mode=showclan&laddertype=2&id=<?=$data[pid]?>"><? } ?><u><font color="#FFFFB0"><u><b><?=$data[name]?></b></u></font></u></a></font>
...
<tr><th colspan="2" align="left" class="maintitle" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="?laddertype=2">XCC community ladder</a> &raquo; Clanstats for [<?=$data[name]?>]</font></th>
</table>
...
$matchtext = "<a href=\"?mode=showplayer&laddertype=2&id=".$rows1["pid"]."\"><Font color=\"FFFF00\">".$rows1["name"]."</a></font> ( ".$pts_clan1." pts ) Plays <a href=\"?mode=showplayer&laddertype=2&id=".$rows2["pid"]."\"><Font color=\"FFFF00\">".$rows2["name"]."</a></font> ( ".$pts_clan2." pts )";

} else {

if($data3[pc] > 1) {

$matchtext = "<a href=\"?mode=showplayer&laddertype=2&id=".$rows1["pid"]."\"><Font color=\"FFFF00\">".$rows1["name"]."</a></font> ( ".$pts_clan1." pts ) Defeats <a href=\"?mode=showplayer&laddertype=2&id=".$rows2["pid"]."\"><Font color=\"FFFF00\">".$rows2["name"]."</a></font> ( ".$pts_clan2." pts )";

} else {

$matchtext = "<a href=\"?mode=showplayer&laddertype=2&id=".$rows2["pid"]."\"><Font color=\"FFFF00\">".$rows2["name"]."</a></font> ( ".$pts_clan2." pts ) Defeats <a href=\"?mode=showplayer&laddertype=2&id=".$rows1["pid"]."\"><Font color=\"FFFF00\">".$rows1["name"]."</a></font> ( ".$pts_clan1." pts )";
...
$map = $map[0];
echo "$month $Tag, $Jahr";
?> - <?=$matchtext?> in game# <a href="?laddertype=2&mode=showmatch&id=<?=$data2[gid]?>"><font color="80FFFF"><u><?=$data2[ws_gid]?></u></font></a>
<hr>
...
?>
<table class="maintitle" width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#000000">
<tr><th class="maintitle" colspan="2" align="left" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="?laddertype=2">XCC community ladder</a> &raquo; Playerstats for <?=$data[name]?></font></th>
</table>
...
$map = $map[0];
echo "$month $Tag, $Jahr";
?> - <?=$matchtext?> in game# <a href="?mode=showmatch&laddertype=2&id=<?=$data2[gid]?>"><font color="80FFFF"><u><?=$data2[ws_gid]?></u></font></a>
<hr>
...
?>
<table class="maintitle" width="100%" border="0" cellspacing="1" cellpadding="2">
<tr><th class="maintitle" colspan="2" align="left" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="?laddertype=2">XCC community ladder</a> &raquo; Match #<?=$data[gid]?></font></th>
</table>
...
if($clansh != "") { $alink = "<a href=\"?mode=showclan&laddertype=2&id=$data3[cid]\">"; } else { $alink = "<a href=\"?mode=showplayer&laddertype=2&id=$data_nick1[pid]\">"; }
?>
