...
<tr><th class="maintitle" colspan="2" align="left" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="<?=$PHP_SELF?>?laddertype=2">XCC community ladder</a> &raquo; Search Result for <?=$id?></font></th>
</table>
...
<td width="12%"><?=$button?>
<td width="32%"><font face="VERDANA,ARIAL,HELVETICA" size="2"><? if($ladr == "player") { ?><a href="<?=$PHP_SELF?>?mode=showplayer&laddertype=2&id=<?=$data[pid]?>"><? } else { ?><a href="<?=$PHP_SELF?>?mode=showclan&laddertype=2&id=<?=$data[pid]?>"><? } ?><u><font color="#FFFFB0"><u><b><?=$data[name]?></b></u></font></u></a></font>
...
<tr><th colspan="2" align="left" class="maintitle" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="<?=$PHP_SELF?>?laddertype=2">XCC community ladder</a> &raquo; Clanstats for [<?=$data[name]?>]</font></th>
</table>
...
?>
<table class="maintitle" width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#000000">
<tr><th class="maintitle" colspan="2" align="left" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="<?=$PHP_SELF?>?laddertype=2">XCC community ladder</a> &raquo; Playerstats for <?=$data[name]?></font></th>
</table>
...
?>
<table class="maintitle" width="100%" border="0" cellspacing="1" cellpadding="2">
<tr><th class="maintitle" colspan="2" align="left" height="30"><span class="thnorm"><font face="Tahoma" size="2">&nbsp;<a href="<?=$PHP_SELF?>?laddertype=2">XCC community ladder</a> &raquo; Match #<?=$data[gid]?></font></th>
</table>
