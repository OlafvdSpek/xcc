<?php
	...
	db_query("delete from xwi_clan_invites where unix_timestamp(ctime) < unix_timestamp() - 7 * 24 * 60 * 60");
	...
	db_query("update xwi_players set flags = flags | 2, mtime = unix_timestamp() where flags = 0 and last_online_time < unix_timestamp() - 3 * 365 * 24 * 60 * 60 and ctime < unix_timestamp() - 31 * 24 * 60 * 60");
