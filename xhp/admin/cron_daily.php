<?php
	...
	db_query("update xwi_players set flags = flags | 2, mtime = unix_timestamp() where last_online_time < unix_timestamp() - 365 * 24 * 60 * 60 and ctime < unix_timestamp() - 31 * 24 * 60 * 60");
