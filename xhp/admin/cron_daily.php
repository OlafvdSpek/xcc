<?php
	...
	db_query("update xwi_players set flags = flags | 2, mtime = unix_timestamp() where flags = 0 and last_online_time < unix_timestamp() - 3 * 365 * 24 * 60 * 60 and ctime < unix_timestamp() - 365 * 24 * 60 * 60");
