...
enum t_file_type
{
	...
	ft_pak, ft_pal, ft_pal_jasc, ft_pcx_single, ft_pcx, ft_png_single, ft_png, ft_riff, ft_rules_ini_ts, ft_rules_ini_ra2, ft_shp_dune2, ft_shp, ft_shp_ts, 
	ft_sound_ini_ts, ft_sound_ini_ra2, ft_st, ft_text, ft_theme_ini_ts, ft_theme_ini_ra2, ft_tmp, ft_tmp_ra, ft_tmp_ts, ft_voc, ft_vqa, ft_vqp, ft_vxl, ft_wav, 
