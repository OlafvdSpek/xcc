...
enum t_file_type
{
	...
	ft_sound_ini_ts, ft_sound_ini_ra2, ft_st, ft_text, ft_tga, ft_theme_ini_ts, ft_theme_ini_ra2, ft_tmp, ft_tmp_ra, ft_tmp_ts, ft_voc, ft_vpl, ft_vqa, ft_vqp, ft_vxl, ft_w3d, ft_wav, 
