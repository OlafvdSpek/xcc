...
<td width="12%"><?=$button?>
<td width="32%"><font size="2"><? if($ladr == "player") { ?><a href="?mode=showplayer&laddertype=2&id=<?=$data[pid]?>"><? } else { ?><a href="?mode=showclan&laddertype=2&id=<?=$data[pid]?>"><? } ?><u><font color="#FFFFB0"><u><b><?=$data[name]?></b></u></font></u></a></font>
