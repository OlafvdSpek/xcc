...
<option value="<?=$PHP_SELF?>?laddertype=3&ladr=player" <? if($ladr == "player" && $laddertype == "3") { echo "selected"; } ?> style="color: #B5B5B5;" >XCL - Player</option>
<option value="<?=$PHP_SELF?>?laddertype=3&ladr=clan" <? if($ladr == "clan" && $laddertype == "3") { echo "selected"; } ?> style="color: #B5B5B5;">XCL - Clan</option>
...
$matchtext = "<a href=\"$PHP_SELF?mode=showplayer&laddertype=3&id=".$rows1["pid"]."\"><Font color=\"FFFF00\">".$rows1["name"]."</a></font> ( ".$pts_clan1." pts ) Plays <a href=\"$PHP_SELF?mode=showplayer&laddertype=3&id=".$rows2["pid"]."\"><Font color=\"FFFF00\">".$rows2["name"]."</a></font> ( ".$pts_clan2." pts )";

} else {

if($data3[pc] > 1) {

$matchtext = "<a href=\"$PHP_SELF?mode=showplayer&laddertype=3&id=".$rows1["pid"]."\"><Font color=\"FFFF00\">".$rows1["name"]."</a></font> ( ".$pts_clan1." pts ) Defeats <a href=\"$PHP_SELF?mode=showplayer&laddertype=3&id=".$rows2["pid"]."\"><Font color=\"FFFF00\">".$rows2["name"]."</a></font> ( ".$pts_clan2." pts )";

} else {

$matchtext = "<a href=\"$PHP_SELF?mode=showplayer&laddertype=3&id=".$rows2["pid"]."\"><Font color=\"FFFF00\">".$rows2["name"]."</a></font> ( ".$pts_clan2." pts ) Defeats <a href=\"$PHP_SELF?mode=showplayer&laddertype=3&id=".$rows1["pid"]."\"><Font color=\"FFFF00\">".$rows1["name"]."</a></font> ( ".$pts_clan1." pts )";
...
if($clansh != "") { $alink = "<a href=\"$PHP_SELF?mode=showclan&laddertype=3&id=$data3[cid]\">"; } else { $alink = "<a href=\"$PHP_SELF?mode=showplayer&laddertype=3&id=$data_nick1[pid]\">"; }
?>
