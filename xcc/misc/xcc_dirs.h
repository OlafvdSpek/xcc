...
public:
	...
	static string get_audio_mix(t_game game, bool expansion);
	static string get_csf_fname(t_game game, bool expansion);
	...
	static string get_language_mix(t_game game, bool expansion);
	static string get_main_mix(t_game game, bool expansion = false);
